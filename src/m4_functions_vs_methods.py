...
def try_methods_and_functions():
    bowden = rg.SimpleTurtle()
    bowden.pen = rg.Pen('blue',5)

    bowden.backward(150)

    bowden.speed = 1
    draw_many_squares(bowden, 2, 100, 30)

    bowden.speed = 5
    color = 'red'
    thickness = 5
    bowden.pen = rg.Pen(color,thickness)
    draw_many_squares(bowden,10,50,15)

    bowden.speed = 100
    thickness = 35
    bowden.pen = rg.Pen(color,thickness)
    draw_many_squares(bowden, 18, 300, 60)

    bowden.pen = rg.Pen('black',3)
    bowden.backward(200)
    bowden.draw_circle(30)
    bowden.draw_square(50)
    ...
    Then make the SimpleTurtle do the following (in the order listed):

...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50), 3, 50, 'red', 1)
    #even_better_draw_circles(rg.Point(-200,0), 15, 20,'blue' , 5)

    even_better_draw_circles(rg.Point(0,0),3,10,'red',3)
    even_better_draw_circles(rg.Point(0,0),5,10,'orange',3)
    even_better_draw_circles(rg.Point(0,0),7,10,'yellow',3)
    even_better_draw_circles(rg.Point(0,0),9,10,'green',3)
    even_better_draw_circles(rg.Point(0,0),11,10,'blue',3)
    even_better_draw_circles(rg.Point(0,0),13,10,'indigo',3)
    even_better_draw_circles(rg.Point(0,0),15,10,'violet',3)

    even_better_draw_circles(rg.Point(300, 0), 3, 10, 'red', 3)
    even_better_draw_circles(rg.Point(300, 0), 5, 10, 'orange', 3)
    even_better_draw_circles(rg.Point(300, 0), 7, 10, 'yellow', 3)
    even_better_draw_circles(rg.Point(300, 0), 9, 10, 'green', 3)
    even_better_draw_circles(rg.Point(300, 0), 11, 10, 'blue', 3)
    even_better_draw_circles(rg.Point(300, 0), 13, 10, 'indigo', 3)
    even_better_draw_circles(rg.Point(300, 0), 15, 10, 'violet', 3)
...
def even_better_draw_circles(center, radius,number,color,thickness):
